...
(cl:defmethod cl:initialize-instance :after ((m <mysrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mysrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myquad-srv:<mysrv-request> is deprecated: use myquad-srv:mysrv-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <mysrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myquad-srv:name-val is deprecated.  Use myquad-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <mysrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mysrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myquad-srv:<mysrv-response> is deprecated: use myquad-srv:mysrv-response instead.")))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <mysrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myquad-srv:age-val is deprecated.  Use myquad-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'weight-val :lambda-list '(m))
(cl:defmethod weight-val ((m <mysrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myquad-srv:weight-val is deprecated.  Use myquad-srv:weight instead.")
  (weight m))
